...
const projects = [
  {
    name: "E-Commerce App",
    description: "Multi-role customer/driver/admin app suite with REST APIs, Firebase backend and robust MVC structure.",
...
const ProjectsSection = () => (
  <section id="projects" className="w-full max-w-3xl mx-auto mb-12 bg-card-dark/80 rounded-lg p-9 shadow-glow-blue border-l-4 border-neon-blue backdrop-blur-lg">
