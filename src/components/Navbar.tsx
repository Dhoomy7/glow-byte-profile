...
const Navbar = () => {
  ...
  return (
    <nav className="fixed z-50 left-1/2 top-7 -translate-x-1/2 px-6 py-4 bg-[#151f28cc] rounded-3xl shadow-glow-blue backdrop-blur-2xl flex items-center gap-8 animate-fade-in navbar-glass">
